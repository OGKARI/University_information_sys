...
<head>
	...
	<link rel="stylesheet" href="../css/spec3.min.css">
</head>
<body>
	...
	<header class="first_display">
		<div class="container">  
			...
			<div class="first_display_text">
				<h1>09.02.07(ВД) Информационные системы и программирование 
					Разработчик веб приложений</h1>
			</div>
		</div>
	</header>
	<section class="content">
		<div class="container">
			<ul>
				<li>Данная квалификация присваевается FrontEnd и BackEnd разработчикам, а именно Веб-дизайнерам и Веб-программистам.</li>
				<li>На данном направление изучают современные технологии проектирования и создания макетов сайтов. Изучаются инструменты 3D моделирования.</li>
				<li>Разработчики WEB и мультимедийных приложений получают богатый опыт в реализации адаптивной верстки сайтов под мобильные, планшетные и компьютерные устройства.</li>
				<li>На данной специализации изучают языки, как HTML, CSS, JavaScript и PHP, включая различные популярные фреймворки и CMS.</li>
				<li>Данная специализация позволяет стать профессиональным программистом для создания WEB-приложений, корпоративных сайтов и Интернет-магазинов.</li>  
			</ul>
		</div>
	</section>
	<!-- Блок футер нужен для создания подвала сайта-->
