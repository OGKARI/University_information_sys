...
<head>
    ...
    <link rel="stylesheet" href="../css/spec.min.css">
</head>
<body>
    ...
    <section class="content">
        <div class="container">
            <div class="content_kafedr">
                <h2>Кафедры</h2>
                <div class="content_kafedr_container" onclick="window.location.href='kafedra1.html'">
                    <h3>09.02.07 «Информационные системы и программирование»</h3>
                </div>
                <div class="content_kafedr_container" onclick="window.location.href='kafedra2.html'">
                    <h3>09.02.06 «Сетевое и системное администрирование»</h3>
                </div>
            </div>
            <div class="content_spec">
                <h2>Специальности</h2>
                <div class="content_spec_container" onclick="window.location.href='spec1.html'">
                    <h3>09.02.06 Сетевое и системное администрирование
                    </h3>
                </div>
                <div class="content_spec_container" onclick="window.location.href='spec2.html'">
                    <h3>09.02.07(БД) Информационные системы и программирование</h3>
                </div>
                <div class="content_spec_container" onclick="window.location.href='spec3.html'">
                    <h3>09.02.07(ВД) Информационные системы и программирование</h3>
                </div>
            </div>
        </div>
    </section>
